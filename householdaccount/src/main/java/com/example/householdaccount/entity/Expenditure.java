...
//		this.lastUpdateUserCode="bb";
	...
	public Expenditure(Expenditure expenditureInfo) {
		this.expenditure_no=expenditureInfo.getExpenditure_no();
		 ...
		 this.expenditureExpenseItemCode=expenditureInfo.getExpenditureExpenseItemCode();
		 this.expenditureExpenseItemName=expenditureInfo.getExpenditureExpenseItemName();
		 this.expenditureDate=expenditureInfo.getExpenditureDate();
		 this.note=expenditureInfo.getNote();
		 this.deleteFrag=true;
		 this.version=expenditureInfo.getVersion();
	}
